		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "EmployeeTime",
									"targetURL": "#employeetime-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"employeetime-display": {
								"semanticObject": "employeetime",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=employeetime",
									"url": sap.ui.require.toUrl("employeetime")
								}
							}
						}
					}
